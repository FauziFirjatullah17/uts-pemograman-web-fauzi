...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="http://localhost/portofolio/views/skills.php" class="nav-link active">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Keammpuan dimiliki</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body table-responsive p-0">
                                    <table id="tb_skill" class="table table-hover text-nowrap">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                                <th>Nama Skill</th>
    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                url: "http://localhost/portofolio/controller/skill.php",
                type: "GET",
                dataType: "json",
                success: function(data) {
                    var table = $("#tb_skill tbody");
                    table.empty(); // Mengosongkan isi tabel sebelum menambahkan data baru

                    $.each(data, function(index, item) {
                        var row = $("<tr>");
                        row.append($("<td>").text(index + 1));
                        row.append($("<td>").text(item.nama_skill));
